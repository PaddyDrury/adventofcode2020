...
class ADay5 {
    ...
    val test = Day5("inputFiles/day5/testinput.txt")
    ...
    @Test
    fun part1() {
        println("day5 part1: ${Day5("inputFiles/day5/input.txt").part1()}")
    }

    @Test
    fun part2() {
        println("day5 part2: ${Day5("inputFiles/day5/input.txt").part2()}")
    }
}
